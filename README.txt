...
CREATE TABLE USUARIO ( ID_USUARIO INT PRIMARY KEY NOT NULL AUTO_INCREMENT, NOME VARCHAR(60) NOT NULL, SOBRENOME VARCHAR(60) NOT NULL, TELEFONE VARCHAR(15), DATA_NASC DATE NOT NULL, EMAIL VARCHAR(60) NOT NULL, PERFIL VARCHAR(1) NOT NULL );
CREATE TABLE SENHA ( ID_SENHA INT PRIMARY KEY NOT NULL AUTO_INCREMENT, ID_USUARIO INT NOT NULL, SENHA VARCHAR(30) NOT NULL );
CREATE TABLE MATERIA ( ID_MATERIA INT PRIMARY KEY NOT NULL AUTO_INCREMENT, MATERIA VARCHAR(30) NOT NULL, SEMESTRE INT NOT NULL );
...
ALTER TABLE SENHA ADD CONSTRAINT FK_SENHAUSUARIO FOREIGN KEY (ID_USUARIO) REFERENCES USUARIO (ID_USUARIO);
...
INSERT INTO USUARIO (NOME, SOBRENOME, TELEFONE, DATA_NASC, EMAIL, PERFIL) VALUES ('GABRIEL','QUEIROZ','+5511999147677',24/08/1993,'GABRIEL.FATEC@HOTMAIL.COM','A');
INSERT INTO SENHA (ID_USUARIO, SENHA) VALUES ('1','GABRIEL');
INSERT INTO USUARIO (NOME, SOBRENOME, TELEFONE, DATA_NASC, EMAIL, PERFIL) VALUES ('VICTOR','HUGO TELES','+5511973224256',27/06/1993,'VICTOR.HTS@GMAIL.COM','A');
INSERT INTO SENHA (ID_USUARIO, SENHA) VALUES ('2','VICTOR');
INSERT INTO USUARIO (NOME, SOBRENOME, TELEFONE, DATA_NASC, EMAIL, PERFIL) VALUES ('BRUNO','HENRIQUE CALIL','+5511985235778',24/08/1993,'BRUHNO.HC@HOTMAIL.COM','A');
INSERT INTO SENHA (ID_USUARIO, SENHA) VALUES ('3','BRUNO');
...
INSERT INTO DUVIDA_TAG (ID_MATERIA, ID_DUVIDA) VALUES ('1','1');
...
INSERT INTO MATERIA_DUVIDA (ID_MATERIA, ID_DUVIDA) VALUES ('26','4');
